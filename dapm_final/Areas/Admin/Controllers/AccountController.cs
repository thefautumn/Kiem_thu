...
using System.Linq;
using dapm_final.Areas.Admin.Models;
...
namespace dapm_final.Areas.Admin.Controllers /*xong*/
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(FYProjectContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        [AllowAnonymous]
        [Route("login.html", Name = "Login")]
        public async Task<IActionResult> AdminLogin(LoginViewModel1 model, string returnUrl = null)
        {
            try
            {
