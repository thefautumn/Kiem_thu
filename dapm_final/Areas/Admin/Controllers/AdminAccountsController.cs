...
{
    [Area("Admin")]
    public class AdminAccountsController : Controller  /*xong*/
    {
        private readonly FYProjectContext _context;
        public INotyfService _notyfService { get; }

        public AdminAccountsController(FYProjectContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var fYProjectContext = _context.Accounts.Include(a => a.Role);
            return View(await fYProjectContext.ToListAsync());
        }
